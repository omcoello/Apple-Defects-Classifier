...
directorio_guardado_modelos = './siames_models/rgb-nir/ResNet50'
...
# Crear modelo ResNet50 preentrenado
...
# Construir el modelo Siamese con ResNet50
...
ruta_guardado_modelo = os.path.join(directorio_guardado_modelos, 'epochs/siamese_ResNet50_epoca_RGB_NIR_{epoch:02d}.h5')

# Callback para TensorBoard
log_dir = "logs_siames/fit/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S") + " ResNet50_RGB_NIR"
