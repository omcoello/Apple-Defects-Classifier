  ...
  try:
    ...
    if len(intersection) > 0:
      for i in range(1, len(intersection)):
        #Spot defect restricting areas greater than 450 and less thn 15150
        area = masks[i]["area"]
        if area >= 400 and area <= 15150:
...
rgbImagesPath = "images/bruise/rgb"
nirImagesPath = "images/bruise/nir"
